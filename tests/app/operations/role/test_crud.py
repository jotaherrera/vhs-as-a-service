...
def test_get_all_roles(db_session: Session) -> None:
    ...
    all_roles = role_repo.get_all(db_session)
...
def test_get_role_by_name(db_session: Session) -> None:
    ...
    db_role = role_repo.get_by_name(db_session, Roles.CUSTOMER)
...
def test_get_role_by_id(db_session: Session) -> None:
    ...
    db_role = role_repo.get_by_id(db_session, role.id)
...
def test_create_role(db_session: Session) -> None:
    ...
    created_role = role_repo.create(db_session, role_create)
